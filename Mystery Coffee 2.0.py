...
def choose_convo_starter(previous_starters):
...
# read previous starters from file or create new empty list
try:
...
convo_starter = choose_convo_starter(previous_starters)
previous_starters.append(convo_starter)


# write previous starters to file
